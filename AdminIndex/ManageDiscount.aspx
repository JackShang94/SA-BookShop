<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManageDiscount.aspx.cs" Inherits="ManageDiscount" %>
...
<body>
	...
	<div class="container">	 			
		...
		<div class="header_bottom_right">			
	        <div class="h_menu4"><!-- start h_menu4 -->
				...
				<ul class="nav">
					<li class="active"><a href="ManageOrders.aspx">ManageOrders</a></li>
					<li><a href="ManageBooks.aspx">ManageBooks</a></li>
					<li><a href="ManageDiscount.aspx">ManageDiscount</a>
					</li>
				</ul>
	      </div><!-- end h_menu4 -->
	      <div class="clearfix"></div>		   
  ...
  <div class="container">
	<div class="search">
	  <div class="stay">Manage Discount</div>	  
	  <div class="clearfix"> </div>
	</div>
	<ul class="social">
		  	  ...
		  	  <form> 
				 <div class="register-top-grid">
					<h3>PERSONAL INFORMATION</h3>
					 <div>
						<span>Start Month<label>*</label></span>
             
                         <asp:TextBox ID="StartMonth" runat="server"></asp:TextBox>
					 </div>
					 <div>
						 <span>Start Day<label>*</label></span>
                         <asp:TextBox ID="StartDay" runat="server"></asp:TextBox>
					 </div>
                     <div>
                         <span>End Month<label>*</label></span>
                         <asp:TextBox ID="EndMonth" runat="server"></asp:TextBox>
                     </div>
                         <div>
                             <span>End Day<label>*</label></span>
                             <asp:TextBox ID="EndDay" runat="server"></asp:TextBox>
                         </div>
					 <div class="clearfix"> </div>
					 </div>
